<template>
  <section
    id="inicio"
    class="relative min-h-[320px] overflow-visible bg-[#f2b2ef] pt-[82px] md:min-h-[700px] xl:pt-[86px]"
  >
    <!-- Fondo -->
    <div
      class="absolute inset-0 bg-[linear-gradient(90deg,#f7b9f2_0%,#f3a9ee_45%,#f7c1f5_100%)]"
    ></div>
    ...
    >
      <p class="hero-script hero-de -translate-x-7 -translate-y-5">de</p>
    ...
    <!-- Fecha -->
    <div
      class="hero-date-enter absolute bottom-[14px] left-[8%] z-40 text-left text-[#b00094] md:bottom-[8px] md:left-[16%]"
    >
      <p class="text-[7px] font-black tracking-[0.18em] sm:text-[13px]">
        19.07.2026
      </p>

      <p class="mt-2 text-[7px] font-black tracking-[0.17em] sm:text-[13px]">
        #CATALINDA15
      </p>
    </div>
